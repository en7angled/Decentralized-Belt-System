...
*Audience: anyone writing Haskell in this repo — naming, formatting, INLINEABLE rules, JSON conventions. Short; read once and refer back.*
...
- Prefer `-- |` on exported functions and types in **new** code and on public library APIs; use `-- ^` for inline field documentation in records where it clarifies meaning.
